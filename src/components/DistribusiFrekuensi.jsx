...
const DistribusiFrekuensi = ({history}) => {
    ...
    const hitung = () => {
      ...
      for(let x=0; x < out.length; x++) {
       ...
       history.push({
        pathname: '/distribusi_frekuensi/result'
       })
    }
	return (
          <>
            ...
            }}><FaArrowLeft color="#48bb78" style={{display: 'inline-block', marginRight: 4}} /></button> Distribusi Frekuensi</h1>
            <hr/>
...
export default withRouter(DistribusiFrekuensi)